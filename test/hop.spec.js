...
test('hop', function (t) {
  ...
  t.equal(hop.ibuTinseth(3, 5.5, 45, 5, 1.066), 45.3876924705429, 'IBU')
  t.equal(hop.ibuTinseth(3, 5.5, 45, 5, 1.066, 'plug'), 49.018707868186326, 'IBU')
  t.equal(hop.ibuTinseth(3, 5.5, 45, 5, 1.066, 'pellet'), 49.92646171759719, 'IBU')
  t.end()
})
